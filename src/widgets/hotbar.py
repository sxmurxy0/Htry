...
class QHotbar(QFrame):
    ...
    def setupFontCategory(self, binder: Binder) -> None:
        ...
        font_input.setFixedSize(145, 28)
    ...
    def setupFormatCategory(self, binder: Binder) -> None:
        bold_button = QPushButton(icon = resource_provider.getIcon(Icons.BOLD))
        bold_button.setFixedSize(28, 28)
        bold_button.setIconSize(QSize(16, 16))
        bold_button.setCheckable(True)

        italic_button = QPushButton(icon = resource_provider.getIcon(Icons.ITALIC))
        italic_button.setFixedSize(28, 28)
        italic_button.setIconSize(QSize(16, 16))
        italic_button.setCheckable(True)

        underlined_button = QPushButton(icon = resource_provider.getIcon(Icons.UNDERLINE))
        underlined_button.setFixedSize(28, 28)
        underlined_button.setIconSize(QSize(16, 16))
        underlined_button.setCheckable(True)
        
        strikethrough_button = QPushButton(icon = resource_provider.getIcon(Icons.STRIKETHROUGH))
        strikethrough_button.setFixedSize(28, 28)
        strikethrough_button.setIconSize(QSize(16, 16))
    ...
    def setupColorCategory(self, binder: Binder) -> None:
        text_color_button = QPushButton(icon = resource_provider.getIcon(Icons.PICKER))
        text_color_button.setFixedSize(28, 28)
        text_color_button.setIconSize(QSize(18, 18))
        text_color_button.setCheckable(True)
        
        background_color_button = QPushButton(icon = resource_provider.getIcon(Icons.FILLING))
    ...
    def setupAlignCategory(self, binder: Binder) -> None:
        align_left_button = QPushButton(icon = resource_provider.getIcon(Icons.ALIGN_LEFT))
        align_left_button.setFixedSize(28, 28)
        align_left_button.setIconSize(QSize(20, 20))
        align_left_button.setCheckable(True)

        align_center_button = QPushButton(icon = resource_provider.getIcon(Icons.ALIGN_CENTER))
        align_center_button.setFixedSize(28, 28)
        align_center_button.setIconSize(QSize(20, 20))
        align_center_button.setCheckable(True)

        align_right_button = QPushButton(icon = resource_provider.getIcon(Icons.ALIGN_RIGHT))
        align_right_button.setFixedSize(28, 28)
        align_right_button.setIconSize(QSize(20, 20))
        align_right_button.setCheckable(True)

        align_justify_button = QPushButton(icon = resource_provider.getIcon(Icons.ALIGN_JUSTIFY))
        align_justify_button.setFixedSize(28, 28)
        align_justify_button.setIconSize(QSize(20, 20))
        align_justify_button.setCheckable(True)

        self.align_category = QHotbar.QCategory(parent = self, title = "Выравнивание",
            widgets = (align_left_button, align_center_button, align_right_button, align_justify_button)) 
        self.layout().addWidget(self.align_category)

        utility.addVerticalSeparator(widget = self, height = 62)
    
    def setupInsertionCategory(self, binder: Binder) -> None:
        picture_button = QPushButton(icon = resource_provider.getIcon(Icons.PICTURE))
        picture_button.setFixedSize(28, 28)
        picture_button.setIconSize(QSize(22, 22))
        picture_button.setCheckable(True)
        
        link_button = QPushButton(icon = resource_provider.getIcon(Icons.LINK))
    ...
    def setupParagraphCategory(self, binder: Binder) -> None:
        ...
        spacing_button.setIconSize(QSize(20, 20))
        ...
        indentation_button.setIconSize(QSize(20, 20))
